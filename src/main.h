...
/** Timeout in vlconds during which a peer must stall block download progress before being disconnected. */
...
/** Time to wait (in vlconds) between writing blockchain state to disk. */
...
extern CCriticalVlction cs_main;
...
extern CWaitableCriticalVlction csBestBlock;
