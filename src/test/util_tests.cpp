...
BOOST_AUTO_TEST_CASE(test_FormatParagraph)
{
    ...
    BOOST_CHECK_EQUAL(FormatParagraph("This is a very long test string. This is a vlcond sentence in the very long test string."), "This is a very long test string. This is a vlcond sentence in the very long\ntest string.");
}
